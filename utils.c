...
/**
 * append_hexa_code - a function that append an ascci in
...
/**
 * is_digit - a function that varifies if a char is a digit
 * @c: Char to be evaluated
 *
...
/**
 * convert_size_unsgnd - a function that casts a number to
 * the specified size
 * @num: Number to be casted
 * @size: Number indicating the type to be casted
 *
